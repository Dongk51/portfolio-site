...
export const ABOUT_SECTIONS = [
  ...
  },
  {
    ...
    content: '개발원 핵심 프로젝트를 진행시 AI Modelingd을 담당했었습니다. Gemini API키를 활용하여 사용자가 원하는 페르소라 구축을 위한 모델과 메타프롬프팅을 추가로 활용하여 페르소나의 얼굴을 유지한채 다른 이미지 생성모델을 구현하였습니다. 추가로 답글 자동 생성 모델을 구현을 위해 허깅페이스에 등록되어 있는 beomi/Llama-3-Open-Ko-8B의 모델을 활용하려 타겟 모듈을 조절하며 학습을 진행 해봤습니다. 이후 답글 자동 생성 모델은 Gemini API로 구현을 활용하여 프로젝트를 진행 하였습니다.',
  },
    {
    id: 'project',
    title: '광주청년일자리드림 경험',
